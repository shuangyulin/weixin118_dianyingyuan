        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="片长">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="dianyingyugao"
                    header-align="center"
                    label="电影预告">
                    <template slot-scope="scope">
                      <el-button type="text" size="small" @click="download(scope.row.dianyingyugao)">预览</el-button>
                    </template>
                  </el-table-column>
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="fangyingting"
